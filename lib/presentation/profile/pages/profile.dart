...
class _ProfilePageState extends State<ProfilePage> {
 late ProfileBloc _bloc;
  ...
  Widget build(BuildContext context) {
   ...
   child: Scaffold(
     appBar: BasicAppbar(title: const Text("Profile",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w600),),color: context.isDarkMode? AppColors.darkGrey:Colors.white,),
    body: Column(
      children: [
        UserDetailsWidget(),
      ],
